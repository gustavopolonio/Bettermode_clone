...
export const GetPostsDocument = gql`
    query GetPosts($filterBy: [PostListFilterByInput!], $postsLimit: Int!, $orderByString: String, $postTypeIds: [String!], $reverse: Boolean, $after: String) {
  posts(
    filterBy: $filterBy
    limit: $postsLimit
